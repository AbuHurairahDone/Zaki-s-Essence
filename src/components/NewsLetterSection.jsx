                            ...
                            {isSubscribed ? (
                                ...
                                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                                    <input
                                        ...
                                        className="form-field flex-1 px-4 py-3 rounded-l-md sm:rounded-r-none border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-700 focus:border-transparent transition-all duration-300"
                                        value={email}
                                    ...
                                    <button
                                        ...
                                        className={`bg-yellow-700 hover:bg-yellow-800 text-white px-6 py-3 rounded-r-md sm:rounded-l-none font-medium btn-animate hover-lift transition-all duration-300 ${isSubmitting || !email ? 'opacity-75 cursor-not-allowed' : ''
                                            }`}
                                    >
                                        {isSubmitting ? (
